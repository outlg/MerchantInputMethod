 ...
 * author purebluesong
 */
public class CandidatesViewGroup_words extends ScrolledViewGroup {
    ...
    public CandidatesViewGroup_words() {
    ...
    protected boolean onCandidateTouchEvent(View v, MotionEvent event) {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                CharSequence textUP = ((TextView) v).getText();
                if(!textUP.toString().equals("")){
